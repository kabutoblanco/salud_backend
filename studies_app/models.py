...
class Study(models.Model):
    ...
    manager_1 = models.ForeignKey(User, related_name="manager_1", on_delete=models.CASCADE, blank=True, null=True)
    manager_2 = models.ForeignKey(User, related_name="manager_2", on_delete=models.CASCADE, blank=True, null=True)
